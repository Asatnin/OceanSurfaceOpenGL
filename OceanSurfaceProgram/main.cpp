...
int main() {
	...
	// create ocean
	OceanSurface ocean = OceanSurface(256, 256, 16.0f, 16.0f, 0.0005f, glm::vec2(15.0f, 0.0f), 9.8f);
	...
	glm::mat4 view = glm::lookAt(glm::vec3(0.0f, 3.0f, 15.0f), glm::vec3(0.0f, 0.0f, 0.0f),
